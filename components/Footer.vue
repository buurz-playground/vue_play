            ...
            <div class="col-md-3">
              <div class="footer-widget "  >
                <div class="footer-logo mb35">
                  <img src="/img/logo/f-logo.png" alt="">
                </div>
                  ...
                  <ul>
                    <li>
                      ...
                      <div class="pop-up-icon">
                        <a href="/img/gallery/g-1.jpg" data-lightbox="roadtrip">
                    ...
                    <li>
                      ...
                      <div class="blakish-overlay"></div>
                      <div class="pop-up-icon">
                        <a href="/img/gallery/g-2.jpg" data-lightbox="roadtrip">
                          <i class="fas fa-search"></i>
                        </a>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="blakish-overlay"></div>
                      <div class="pop-up-icon">
                        <a href="/img/gallery/g-3.jpg" data-lightbox="roadtrip">	<i class="fas fa-search"></i></a>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="blakish-overlay"></div>
                      <div class="pop-up-icon">
                        <a href="/img/gallery/g-4.jpg" data-lightbox="roadtrip">	<i class="fas fa-search"></i></a>
                      </div>
                    </li>
                    <li>
                      <img src="/img/gallery/g-5.jpg" alt="">
                      <div class="blakish-overlay"></div>
                      <div class="pop-up-icon">
                        <a href="/img/gallery/g-5.jpg" data-lightbox="roadtrip">	<i class="fas fa-search"></i></a>
                      </div>
                    </li>
                    <li>
                      <img src="/img/gallery/g-6.jpg" alt="">
                      <div class="blakish-overlay"></div>
                      <div class="pop-up-icon">
                        <a href="/img/gallery/g-6.jpg" data-lightbox="roadtrip">	<i class="fas fa-search"></i></a>
                      </div>
